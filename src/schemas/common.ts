...
// RNF-08: monto monetario — número positivo con máximo 2 decimales
...
// RNF-09: correo electrónico válido (formato RFC 5322 simplificado)
export const emailSchema = z
  .string()
  .email('Formato de correo electrónico inválido')
  .max(254);

// RNF-03: política de contraseña — 5-8 chars, ≥1 mayúscula, ≥1 número, ≥1 especial
